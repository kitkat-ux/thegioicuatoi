...
export const BEAST_ASSETS = {
    ...
    qingluan: {
        key: 'beast_qingluan',
        path: 'assets/beasts/beast_qingluan.png',
        width: 320,
        height: 288,
        origin: { x: 0.5, y: 0.5 },
        description: 'Thanh Loan — Tiên điểu lông vũ ngọc bích phát sáng ánh phong linh',
        rarity: 'legendary',
    },
    xuanwu: {
        key: 'beast_xuanwu',
        path: 'assets/beasts/beast_xuanwu.png',
        width: 384,
        height: 248,
        origin: { x: 0.5, y: 0.5 },
        description: 'Huyền Quy — Linh thú mai rùa cổ kính phủ rêu tiên, linh giáp khắc phù văn phát sáng',
        rarity: 'legendary',
    },
    nest_platform: {
        key: 'nest_platform',
